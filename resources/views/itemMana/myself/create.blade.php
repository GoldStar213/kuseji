        ...
        <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">アイテム登録</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
            </div>
                                    ...
                                    <div class="row g-10 mb-2">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select aria-label="選択" id="join_type" name="join_type" data-control="select2" data-placeholder="選択" class="form-select form-select-solid form-select-lg">
                                                <option data-kt-flag="flags/united-states.svg" value="0" {{ old('join_type') == 0 ? 'selected' : '' }}>はい</option>
                                                <option data-kt-flag="flags/united-states.svg" value="1" {{ old('join_type') == 1 ? 'selected' : '' }}>いいえ</option>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                    </div>
